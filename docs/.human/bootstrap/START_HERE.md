...
Copy the short text block from [chatgpt-project-instructions.md](templates/chatgpt-project-instructions.md) into Project instructions and replace the repository placeholder immediately with the actual owner/repository. Keep those instructions short; they route to repository context. Existing discussions may be moved into the Project when the current product supports it.
...
Open `app/index.html` locally. Select English or Portuguese and answer what you know. Unknown is valid; do not research technical details merely to fill the form. The app collects intent, preferences and constraints, not architecture.
